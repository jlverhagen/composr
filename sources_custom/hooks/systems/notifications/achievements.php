 ...
 * Hook class.
 */
class Hook_notification_achievements extends Source_hook_notification
{
    /**
    ...
    public function list_handled_codes() : array
    {
        ...
        $list = [];
        $list['achievement_unlocked'] = [do_lang('achievements:ACHIEVEMENTS'), do_lang('achievements:NOTIFICATION_TYPE_achievement_unlocked')];
        $list['achievement_revoked'] = [do_lang('achievements:ACHIEVEMENTS'), do_lang('achievements:NOTIFICATION_TYPE_achievement_revoked')];
        return $list;
    }
    ...
    public function list_members_who_have_enabled(string $notification_code, ?string $category = null, ?array $to_member_ids = null, ?int $from_member_id = null, int $start = 0, int $max = 300) : array
    {
        ...
        $members = $this->_all_members_who_have_enabled_with_page_access($members, 'achievements', $notification_code, $category, $to_member_ids, $start, $max);
