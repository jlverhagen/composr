 ...
 * Hook class.
 */
class Hook_notification_downloads_followup_email extends Source_hook_notification
{
    /**
    ...
    public function list_handled_codes() : array
    {
        ...
        $list = [];
        $list['downloads_followup_email'] = [do_lang('CONTENT'), do_lang('downloads_followup_email:NOTIFICATION_TYPE_downloads_followup_email')];
        return $list;
    }
