...
class Hook_database_manifest_giftr
{
    ...
    public function get_table_purpose_flags() : array
    {
        ...
        return [
            'giftr' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__NON_BUNDLED,
            'members_gifts' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__NON_BUNDLED | TABLE_PURPOSE__FLUSHABLE_AGGRESSIVE | TABLE_PURPOSE__SUBDATA/*under f_members*/,
        ];
    }
