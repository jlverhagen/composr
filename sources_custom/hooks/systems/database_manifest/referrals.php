...
class Hook_database_manifest_referrals
{
    ...
    public function get_table_purpose_flags() : array
    {
        ...
        return [
            'referees_qualified_for' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__NON_BUNDLED | TABLE_PURPOSE__FLUSHABLE_AGGRESSIVE,
            'referrer_override' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__NON_BUNDLED | TABLE_PURPOSE__FLUSHABLE_AGGRESSIVE,
        ];
    }
