...
{
    public $label = 'downloads_followup_email:DOWNLOADS_FOLLOWUP_EMAIL_CRON';
    public $fallback_label = 'Send download follow-up e-mails';
        ...
        */
        ...
        do {
            ...
            foreach ($member_ids as $id) {
                ...
                Source_notification_dispatcher::dispatch_notification('downloads_followup_email', '', $subject_line, $message, [$member_id], A_FROM_SYSTEM_PRIVILEGED);
            }
