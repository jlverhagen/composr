...
class Hook_admin_stats_google_keywords extends CMSStatsProvider
{
    ...
    public function info(bool $for_kpi = false) : ?array
    {
        ...
        list($min_month, $max_month) = find_known_stats_day_bounds();
        ...
        return [
            'google_keywords_hits' => [
                ...
                'filters' => [
                    'google_keywords_hits__day_range' => new CMSStatsDayRangeFilter('google_keywords_hits__day_range', do_lang_tempcode('DATE_RANGE'), [$max_month - 12, $max_month], $for_kpi),
            ...
            'google_keywords_impressions' => [
                ...
                'category' => 'search_traffic',
                'filters' => [
                    'google_keywords_impressions__day_range' => new CMSStatsDayRangeFilter('google_keywords_impressions__day_range', do_lang_tempcode('DATE_RANGE'), [$max_month - 12, $max_month], $for_kpi),
            ...
            'google_keywords_ctr' => [
                ...
                'category' => 'search_traffic',
                'filters' => [
                    'google_keywords_ctr__day_range' => new CMSStatsDayRangeFilter('google_keywords_ctr__day_range', do_lang_tempcode('DATE_RANGE'), [$max_month - 12, $max_month], $for_kpi),
            ...
            'google_keywords_positions' => [
                ...
                'category' => 'search_traffic',
                'filters' => [
                    'google_keywords_positions__day_range' => new CMSStatsDayRangeFilter('google_keywords_positions__day_range', do_lang_tempcode('DATE_RANGE'), [$max_month - 12, $max_month], $for_kpi),
