    ...
    if ($type == 'step1') { // Ask for block
        ...
        foreach ($zones as $_zone) {
            ...
            foreach ($pages as $filename => $type) {
                if (cms_strtolower_ascii(substr($filename, -4)) == '.txt') {
                    $matches = [];
        ...
        foreach ($param_classes as $param_class => $parameters) {
            ...
            foreach ($parameters as $parameter) {
                ...
                if ($parameter == 'zone') { // zone list
                    ...
                    ksort($hooks);
                    $is_multi_list = ((($block == 'main_search') || ($block == 'top_search')) && ($parameter == 'limit_to')) || ($block == 'side_tag_cloud') || ($block == 'main_multi_content'); // FUDGE
