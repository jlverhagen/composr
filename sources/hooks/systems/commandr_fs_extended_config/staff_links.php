 ...
 * Hook class.
 */
class Hook_commandr_fs_extended_config__staff_links
{
    /**
    ...
    {
        return table_to_json('staff_links', ['id']);
    }
    ...
    {
        return table_from_json('staff_links', $contents, [], TABLE_REPLACE_MODE_SEVERE);
    }
}
