 ...
 * Hook class.
 */
class Hook_commandr_fs_extended_config__wordfilter
{
    /**
    ...
    {
        return addon_installed('wordfilter');
    }
    ...
    {
        return table_to_json('wordfilter', ['id']);
    }
    ...
    {
        return table_from_json('wordfilter', $contents, [], TABLE_REPLACE_MODE_SEVERE);
    }
}
