 ...
 * Hook class.
 */
class Hook_commandr_fs_extended_config__ecom_prods_permissions
{
    /**
    ...
    {
        $query = 'SELECT MAX(date_and_time) FROM ' . get_table_prefix() . 'actionlogs WHERE ' . db_string_equal_to('the_type', 'ECOM_PRODUCTS_AMEND_CUSTOM_PERMISSIONS');
    ...
    {
        return table_to_json('ecom_prods_permissions');
    }
    ...
    {
        return table_from_json('ecom_prods_permissions', $contents, [], TABLE_REPLACE_MODE_SEVERE);
    }
}
