 ...
 * Hook class.
 */
class Hook_sitemap_page_grouping extends Source_hook_sitemap_base
{
    /**
     ...
     */
    public function get_node(string $page_link, $callback = null, ?array $valid_node_types = null, ?int $child_cutoff = null, ?int $max_recurse_depth = null, int $recurse_level = 0, int $options = 0, string $zone = '_SEARCH', int $meta_gather = 0, ?array $orphaned_pages = null, bool $return_anyway = false) : ?array
    {
