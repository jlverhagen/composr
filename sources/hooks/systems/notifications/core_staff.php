 ...
 * Hook class.
 */
class Hook_notification_core_staff extends Source_hook_notification__staff
{
    /**
    ...
    {
        if (($this->is_first_admin($member_id)) && (($notification_code == 'spam_check_block') || ($notification_code == 'auto_ban'))) {
