 ...
 * Hook class.
 */
class Hook_notification_newsletter_paused extends Source_hook_notification__staff
{
    /**
    ...
    public function list_handled_codes() : array
    {
        ...
        $list = [];
        $list['newsletter_paused'] = [do_lang('newsletter:NEWSLETTER'), do_lang('newsletter:NOTIFICATION_TYPE_newsletter_paused')];
        return $list;
    }
}
