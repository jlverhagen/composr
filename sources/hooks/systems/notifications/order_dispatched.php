 ...
 * Hook class.
 */
class Hook_notification_order_dispatched extends Source_hook_notification
{
    /**
    ...
    public function list_handled_codes() : array
    {
        ...
        $list = [];
        $list['order_dispatched'] = [do_lang('ecommerce:ECOMMERCE'), do_lang('shopping:NOTIFICATION_TYPE_order_dispatched')];
        return $list;
    }
