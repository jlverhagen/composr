 ...
 * Hook class.
 */
class Hook_notification_ticket_reply_staff extends Source_hook_notification
{
    /**
    ...
    public function list_handled_codes() : array
    {
        ...
        $list = [];
        $list['ticket_reply_staff'] = [do_lang('MESSAGES'), do_lang('tickets:NOTIFICATION_TYPE_ticket_reply_staff')];
        return $list;
    }
