 ...
 * Hook class.
 */
class Hook_resource_meta_aware_multi_moderation extends Hook_CMA
{
    /**
    ...
    public function info(?string $zone = null, bool $get_extended_data = false) : ?array
    {
        ...
        return [
            ...
            'description_field' => 'mm_post_text',
            ...
            'add_url' => ($get_extended_data && function_exists('get_member') && has_actual_page_access(get_member(), 'admin_cns_multi_moderations')) ? (get_module_zone('admin_cns_multi_moderations') . ':admin_cns_multi_moderations:add') : null,
            'archive_url' => null,
