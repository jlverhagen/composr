 ...
 * Hook class.
 */
class Hook_resource_meta_aware_kpi
{
    /**
    ...
    public function info(?string $zone = null, bool $get_extended_data = false) : ?array
    {
        ...
        return [
            ...
            'content_type_label' => 'stats:KPI',
            'content_type_universal_label' => 'KPI',

            'db' => get_db_for('stats_kpis'),
            'table' => 'stats_kpis',
            'id_field' => 'id',
            ...
            'edit_page_link_pattern' => '_SEARCH:admin_stats:_edit:_WILD',
            'view_category_page_link_pattern' => null,
            'add_url' => null,
            'archive_url' => '_SEARCH:admin_stats:kpis',
