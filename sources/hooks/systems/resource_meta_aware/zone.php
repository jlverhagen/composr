 ...
 * Hook class.
 */
class Hook_resource_meta_aware_zone extends Source_hook_CMA
{
    /**
    ...
    public function info(?string $zone = null, bool $get_extended_data = false) : ?array
    {
        return [
            ...
            'add_url' => ($get_extended_data && function_exists('get_member') && has_actual_page_access(get_member(), 'admin_zones')) ? (get_module_zone('admin_zones') . ':admin_zones:add') : null,
            'archive_url' => null,
