...
// Symbol needs to be in core and not themewizard so themes using theme wizard equations still work if the addon is removed.

/**
 * Hook class.
 */
class Hook_symbol_THEMEWIZARD_COLOR
{
    /**
