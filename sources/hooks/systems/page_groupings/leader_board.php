 ...
 * Hook class.
 */
class Hook_page_groupings_leader_board
{
    /**
    ...
    public function run(?int $member_id = null, bool $extensive_docs = false) : array
    {
        ...
        return [
            ...
            ['setup', 'menu/social/leader_board', ['admin_leader_board', [], get_module_zone('admin_leader_board')], do_lang_tempcode('leader_board:LEADER_BOARDS'), 'leader_board:DOC_LEADER_BOARDS'],
        ];
    }
}
