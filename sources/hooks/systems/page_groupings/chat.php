...
class Hook_page_groupings_chat
{
    ...
    public function run(?int $member_id = null, bool $extensive_docs = false) : array
    {
        ...
        return [
            ['cms', 'menu/social/chat/chat', ['cms_chat', ['type' => 'browse'], get_module_zone('cms_chat')], do_lang_tempcode('ITEMS_HERE', do_lang_tempcode('chat:CHAT_MODERATION'), make_string_tempcode(escape_html(integer_format(intval($GLOBALS['SITE_DB']->query_select_value('chat_rooms', 'COUNT(*)', ['is_im' => 0])), 0)))), 'chat:DOC_CHAT'],
