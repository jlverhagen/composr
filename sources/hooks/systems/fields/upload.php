...
class Hook_fields_upload
{
    ...
    public function get_field_inputter(string $_cf_name, string $_cf_description, array $field, ?string $actual_value, bool $new) : ?array
    {
        ...
        $ffield = form_input_upload($_cf_name, $cf_description, $input_name, $say_required, $actual_value, null, true, $filetype_filter);
        ...
        if (!fractional_edit()) {
            ...
            if ($value != '') {
                if (strpos($value, '::') !== false) { // Required for security, else someone may be able to delete any file by putting "::" at the end of a matching filename they upload and then delete
                    warn_exit(do_lang_tempcode('INTERNAL_ERROR', escape_html('c444fdd14e345d68990a41920c5c6873')));
                }
