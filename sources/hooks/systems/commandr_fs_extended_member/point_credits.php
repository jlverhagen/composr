...
class Hook_commandr_fs_extended_member__point_credits
{
    ...
    {
        return table_to_portable_rows('points_ledger', ['id'], ['receiving_member' => $member_id]);
    }
    ...
    {
        table_from_portable_rows('points_ledger', $data, ['receiving_member' => $member_id], TABLE_REPLACE_MODE_BY_EXTRA_FIELD_DATA);
    }
}
