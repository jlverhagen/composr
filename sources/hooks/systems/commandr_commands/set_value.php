 ...
 * Hook class.
 */
class Hook_commandr_command_set_value
{
    /**
    ...
    public function run(array $options, array $parameters, object &$commandr_fs) : array
    {
        ...
        if (!array_key_exists(0, $parameters)) {
            return ['', '', '', do_lang('MISSING_PARAM', '1', 'set_value')];
        }
        if (!array_key_exists(1, $parameters)) {
            return ['', '', '', do_lang('MISSING_PARAM', '2', 'set_value')];
        }

        list($name, $value) = $parameters;

        set_value($name, $value, array_key_exists('e', $options));
