 ...
 * Hook class.
 */
class Hook_media_rendering_audio_general extends Source_media_renderer_with_fallback
{
    /**
    ...
    public function render($url, $url_safe, array $attributes, bool $as_admin = false, ?int $source_member = null, ?string $url_direct_filesystem = null, ?string $original_filename = null) : object
    {
        ...
        return do_template('MEDIA_VIDEO_GENERAL', ['_GUID' => '2ed16d6e74265c0b51c2415731378827', 'HOOK' => 'audio_general'] + _create_media_template_parameters($url, $attributes, $as_admin, $source_member));
    }
}
