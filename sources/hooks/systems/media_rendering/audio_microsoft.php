 ...
 * Hook class.
 */
class Hook_media_rendering_audio_microsoft extends Source_media_renderer_with_fallback
{
    /**
    ...
    public function render($url, $url_safe, array $attributes, bool $as_admin = false, ?int $source_member = null, ?string $url_direct_filesystem = null, ?string $original_filename = null) : object
    {
        ...
        return do_template('MEDIA_VIDEO_GENERAL', ['_GUID' => 'f283bf03e092b6e649c661080a598666', 'HOOK' => 'audio_microsoft'] + _create_media_template_parameters($url, $attributes, $as_admin, $source_member));
    }
}
