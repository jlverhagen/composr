...
class Hook_login_provider_httpauth
{
     ...
     */
    public function try_login(?int $member_id, bool $quick_only = false) : ?int
    {
        ...
        if (get_forum_type() == 'cns') {
            ...
            if ((!@cms_empty_safe($_SERVER['PHP_AUTH_USER'])) && (($member_id === null) || (is_guest($member_id))) && ((get_option('httpauth_is_enabled') == '1') || (get_value('windows_auth_is_enabled') === '1'))) {
                require_code('users_inactive_occasionals');
