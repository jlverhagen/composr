...
class Hook_addon_registry_chat
{
    ...
    public function get_file_list() : array
    {
        return [
            ...
            'data/sounds/chat/contact_off.mp3',
            'data/sounds/chat/contact_on.mp3',
            'data/sounds/chat/error.mp3',
            'data/sounds/chat/index.html',
            'data/sounds/chat/invited.mp3',
            'data/sounds/chat/message_background.mp3',
            'data/sounds/chat/message_initial.mp3',
            'data/sounds/chat/message_received.mp3',
            'data/sounds/chat/message_sent.mp3',
            'data/sounds/chat/you_connect.mp3',
