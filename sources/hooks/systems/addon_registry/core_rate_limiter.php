 ...
 * Hook class.
 */
class Hook_addon_registry_core_rate_limiter
{
    /**
    ...
    {
        return "Provides a basic software-level rate limiter to prevent excessive requests to your website.";
    }
    ...
    {
        return [
            'sources/hooks/systems/addon_registry/core_rate_limiter.php',
            'sources/rate_limiter.php',
    ...
    {
        @unlink(get_custom_file_base() . '/data_custom/sqlitedb/rate_limiter.sqlite');
    }
    ...
    public function install(?float $upgrade_major_minor = null, ?int $upgrade_patch = null)
    {
        if ($upgrade_major_minor === null) {
            ...
            // Create the table
            $statement = $db_link->prepare('CREATE TABLE "rate_limiting" ("id" INTEGER, "ip" TEXT, "date_and_time" INTEGER, PRIMARY KEY("id" AUTOINCREMENT));');
            $statement->execute();
            $statement->close();
            $db_link->close();
        }
