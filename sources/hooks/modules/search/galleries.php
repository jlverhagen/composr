 ...
 * Hook class.
 */
class Hook_search_galleries extends Source_hook_search_base
{
    /**
    ...
    public function run(string $search_query, string $content_where, string $where_clause, string $search_under, bool $only_search_meta, bool $only_titles, int $max, int $start, string $sort, string $direction, string $author, ?int $author_id, $cutoff) : array
    {
        ...
        $table = 'galleries r';
        $trans_fields = ['r.fullname' => 'SHORT_TRANS__COMCODE', 'r.the_description' => 'LONG_TRANS__COMCODE'];
        $nontrans_fields = [];
        ...
        $rows = get_search_rows('gallery', 'name', $search_query, $content_where, $where_clause, $only_search_meta, $only_titles, $max, $start, $remapped_orderer, $direction, $table, 'r.*', $trans_fields, $nontrans_fields, 'galleries', 'name', true);
