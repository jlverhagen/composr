 ...
 * Hook class.
 */
class Hook_search_images extends Source_hook_search_base
{
    /**
    ...
    public function run(string $search_query, string $content_where, string $where_clause, string $search_under, bool $only_search_meta, bool $only_titles, int $max, int $start, string $sort, string $direction, string $author, ?int $author_id, $cutoff) : array
    {
        ...
        $rows = get_search_rows('image', 'id', $search_query, $content_where, $where_clause, $only_search_meta, $only_titles, $max, $start, $remapped_orderer, $direction, $table . $privacy_join, 'r.*', $trans_fields, $nontrans_fields, 'galleries', 'cat', true);
