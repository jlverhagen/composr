 ...
 * Hook class.
 */
class Hook_search_wiki_pages extends Source_hook_search_base
{
    /**
    ...
    public function info(bool $check_permissions = true, ?int $member_id = null)
    {
        ...
        if ($GLOBALS['SITE_DB']->get_table_count_approx('wiki_pages') <= 1) {
            return null;
        }
    ...
    public function run(string $search_query, string $content_where, string $where_clause, string $search_under, bool $only_search_meta, bool $only_titles, int $max, int $start, string $sort, string $direction, string $author, ?int $author_id, $cutoff) : array
    {
        ...
        $rows = get_search_rows('wiki_page', 'id', $search_query, $content_where, $where_clause, $only_search_meta, $only_titles, $max, $start, $remapped_orderer, $direction, $table, 'r.*', $trans_fields, $nontrans_fields, 'wiki_page', 'id');
