 ...
 * Hook class.
 */
class Hook_admin_stats_support_tickets extends Source_hook_stats_provider
{
    /**
    ...
    public function info(bool $for_kpi = false) : ?array
    {
        ...
        return [
            'support_tickets' => [
                ...
                'filters' => [
                    'support_tickets__day_range' => new Source_stats_filter_day_range('support_tickets__day_range', do_lang_tempcode('DATE_RANGE'), null, $for_kpi),
                ],
                'pivot' => new Source_stats_filter_date_pivot('support_tickets__pivot', $this->get_date_pivots(!$for_kpi)),
