        ...
        do {
            ...
            foreach ($rows as $row) {
                ...
                foreach (array_keys($date_pivots) as $pivot) {
                    ...
                    if (!isset($data_buckets['sitemap_growth'][$pivot][$pivot_interval][$pivot_value][$page_link])) {
                        $data_buckets['sitemap_growth'][$pivot][$pivot_interval][$pivot_value][$page_link] = 0;
                    }
