...
class Block_side_shoutbox
{
    ...
    public function caching_environment() : ?array
    {
        ...
        [
            ...
            array_key_exists('param', $map) ? intval($map['param']) : null,
        ]
PHP;
    ...
    public function run(array $map) : object
    {
        ...
        $room_id = @cms_empty_safe($map['param']) ? null : intval($map['param']);
        ...
        $last_message_id = $GLOBALS['SITE_DB']->query_select_value('chat_messages', 'MAX(id)', ['room_id' => $room_id]);
