 ...
 */
class cqc_rest_test_set extends cms_test_case
{
    public function testRest()
    {
        ...
        $url = get_base_url() . '/_tests/codechecker/codechecker.php?avoid=sources,site,adminzone,cms,forum,pages,data_custom';
