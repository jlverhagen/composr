    ...
    public function cancel() : object
    {
        ...
        if (!in_array($payment_gateway, ['', 'manual', 'points'])) {
            ...
            if ($payment_gateway_object->auto_cancel($id) !== true) {
                ...
                Source_notification_dispatcher::dispatch_notification('subscriptions_staff', null, do_lang('SUBSCRIPTION_CANCELLED_SUBJECT', null, null, null, get_site_default_lang()), do_notification_lang('SUBSCRIPTION_CANCELLED_BODY', $trans_id, $username, null, get_site_default_lang()));
            }
        }
