...
$decision_tree = [
    'start' => [
        ...
        'notice' => [
            ...
            ['service_type',  'Report an issue or request a feature',                     'Please only report bugs that look to be genuine bugs in the Composr CMS code (and not bugs that exist in your own custom code). You will be redirected to the report issue wizard which will guide you on reporting a bug to us.' . "\n\n" . 'If you have a [i]very high urgency[/i] to get a bug fixed, or if you want a hotfix deployed and tested for you individually, this is not something that can be offered for free. Consider hiring a developer or going through this form again under Professional services.'],
