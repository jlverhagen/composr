...
<div class="fields-set-item{+START,IF_NON_EMPTY,{EXTRA_CLASSES}} {EXTRA_CLASSES*}{+END}" data-tpl="formScreenFieldsSetItem" data-tpl-params="{+START,PARAMS_JSON,NAME}{_*}{+END}" id="field_set_{NAME%}">
