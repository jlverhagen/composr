...
{+START,SET,hero_slider}
	{+START,IF,{$NEQ,{$CONFIG_OPTION,site_closed},2}}
		{+START,IF,{$AND,{$ADDON_INSTALLED,galleries},{$MATCH_KEY_MATCH,:home,site:home}}}{+START,IF,{$THEME_OPTION,homepage_slider_enabled}}
			{$BLOCK,block=main_hero_slider,block_id=homepage-hero,gallery_name={$THEME_OPTION,homepage_slider_gallery},blank_if_empty=1,effect={$THEME_OPTION,homepage_slider_effect},interval={$THEME_OPTION,homepage_slider_cycle_duration},fullscreen={$THEME_OPTION,homepage_slider_fullscreen},show_scroll_down=1,check=0,sort=title ASC}
		{+END}{+END}
	{+END}
{+END}
